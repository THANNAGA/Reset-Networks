...
The figure above shows final preference maps of Reset(1), (2), (4) and (8) networks trained on Cifar-100, as well as their mean cluster sizes throughout training. I tested the networks' preferences on 3 macro-categories - objects, houses and people - obtained by agregating the relevant cifar-100 classes. 
